...
- Version 1: Console Based Chess Game 'Engine' -> Branch 1
    ...
    - v 1.3: Undo Functionality, Switch Players, Switching Board Views, Forced Draws

- Version 2: GUI Based Chess Game 'Engine' -> Branch 2
- Version 3: Client-Server [Chess Game Engine Online] -> Branch 